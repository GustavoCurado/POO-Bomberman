CC = g++
CFLAGS = -g3 -lsfml-graphics -lsfml-window -lsfml-system
...
all: $(wildcard *.cpp)
	...
	$(CC) $(SRC)/main.cpp $(OBJ)/game.o $(OBJ)/map.o $(OBJ)/entity.o $(OBJ)/bomberman.o $(OBJ)/enemy.o $(INCLUDE) $(CFLAGS) -o $(BIN)/Bomberman
